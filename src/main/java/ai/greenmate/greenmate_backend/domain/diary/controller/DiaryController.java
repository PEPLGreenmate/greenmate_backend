...
public class DiaryController {
  ...
  @GetMapping
  public ResponseEntity<BaseResponse> getDiaries(@RequestParam("greenmateId") String greenmateId){
    GetDiariesResponse getDiariesResponse = diaryService.getAllDiaries(greenmateId);
